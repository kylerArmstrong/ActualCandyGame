...
public class CandySelect : MonoBehaviour
{
    ...
    public void Increase()
    {
        ...
        {
            currentAmount++;
            candyManager.GetComponent<candyButtonManager>().increaseBargain(chosenCandy);
    ...
    public void Decrease()
    {
        ...
        {
            currentAmount--;
            candyManager.GetComponent<candyButtonManager>().decreaseBargain(chosenCandy);
        }
    }
}
